...
- Ir a los archivos .feature (src>test>resources>com.developer.mitienda) agregar tus escenarios, métodos de prueba, aserciones, y todo lo necesario para tus pruebas en particular.
